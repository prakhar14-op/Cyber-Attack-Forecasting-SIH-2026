...
export const DEMO_SOURCES: DemoSource[] = [
  ...
  },
  {
    ...
    kind: 'pcap',
    engine_variant: 'full',
    detail: 'Real-world HTTPS Denial of Service (T1498) packet capture.',
    available: true,
    bytes: 7_147_512,
    build_hint: null,
  },
  {
    ...
    kind: 'pcap',
    engine_variant: 'full',
    detail: 'Authentic UNB CSE-CIC-IDS2018 capture for host 172.31.66.114 (tested in Streamlit demo).',
    available: true,
    bytes: 48_567_837,
    build_hint: null,
  },

...
- On that protocol the graded logistic-regression baseline reaches **AUROC 0.573** — near chance.
  The shipped fused model reaches 0.933 (≈ 0.89 de-duplicated) with 2/2 episodes at ~49–91 min
...
- **Alert volume.** At the published 1 % budget this system implies roughly 84,000 alerts/day on
